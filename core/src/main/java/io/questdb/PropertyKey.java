...
public enum PropertyKey implements ConfigPropertyKey {
    ...
    CAIRO_READER_POOL_AUTO_REFRESH_ENABLED("cairo.reader.pool.auto.refresh.enabled"),
    ...
    CAIRO_SQL_COPY_EXPORT_ROOT("cairo.sql.copy.export.root"),
    ...
    HTTP_EXPORT_TIMEOUT("http.export.timeout"),
    ...
    HTTP_EXPORT_CONNECTION_LIMIT("http.export.connection.limit"),
    ...
    CAIRO_PARQUET_EXPORT_TABLE_PREFIX("cairo.parquet.export.table.prefix"),
    CAIRO_PARQUET_EXPORT_COPY_REPORT_FREQUENCY_LINES("cairo.parquet.export.copy.report.frequency.lines"),
    CAIRO_PARQUET_EXPORT_VERSION("cairo.parquet.export.version"),
    CAIRO_PARQUET_EXPORT_STATISTICS_ENABLED("cairo.parquet.export.statistics.enabled"),
    CAIRO_PARQUET_EXPORT_RAW_ARRAY_ENCODING_ENABLED("cairo.parquet.export.raw.array.encoding.enabled"),
    ...
    EXPORT_WORKER_SLEEP_TIMEOUT("export.worker.sleep.timeout"),
