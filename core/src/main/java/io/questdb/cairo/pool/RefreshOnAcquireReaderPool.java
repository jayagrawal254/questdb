...
public class RefreshOnAcquireReaderPool extends AbstractMultiTenantPool<RefreshOnAcquireReaderPool.R> implements ReaderPool<RefreshOnAcquireReaderPool.R> {
    ...
    public RefreshOnAcquireReaderPool(CairoConfiguration configuration, TxnScoreboardPool scoreboardPool, MessageBus messageBus, PartitionOverwriteControl partitionOverwriteControl) {
    ...
    public RefreshOnAcquireReaderPool(CairoConfiguration configuration, TxnScoreboardPool scoreboardPool, MessageBus messageBus) {
    ...
    public TableReader getCopyOf(TableReader srcReader) {
        return getCopyOf((RefreshOnAcquireReaderPool.R) srcReader);
    }
    ...
    public void refreshAllUnallocatedReaders() {
        // noop, readers are refreshed on acquired
    }
